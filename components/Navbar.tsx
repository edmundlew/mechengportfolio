...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-4 md:top-8 left-1/2 -translate-x-1/2 z-[9999] w-max max-w-[calc(100vw-1.5rem)]">
      <div className="relative flex items-center gap-1 sm:gap-4 px-3 sm:px-6 py-2 sm:py-2.5 bg-white/80 backdrop-blur-xl border border-zinc-200/50 shadow-2xl shadow-zinc-900/5 rounded-full">
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`relative px-2.5 sm:px-4 py-1.5 z-10 text-xs sm:text-sm whitespace-nowrap transition-colors duration-300 ${
