...
export default function ProjectCard({ project, onClick }: ProjectCardProps) {
    ...
    return (
        ...
        >
            ...
            {/* Text Section (30%) */}
            <div className="h-[30%] p-5 md:p-8 flex flex-col justify-center bg-white relative z-10">
                <div className="flex justify-between items-start">
                    <div className="min-w-0">
                        <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-zinc-900 mb-2 truncate pr-4">{project.title}</h3>
